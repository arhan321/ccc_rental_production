...
class PengembalianPolicy
{
    ...
    {
        return $user->can('view_any_pengembalian');
    }
    ...
    {
        return $user->can('view_pengembalian');
    }
    ...
    {
        return $user->can('create_pengembalian');
    }
    ...
    {
        return $user->can('update_pengembalian');
    }
    ...
    {
        return $user->can('delete_pengembalian');
    }
    ...
    {
        return $user->can('delete_any_pengembalian');
    }
     ...
     */
    public function replicate(User $user, Pengembalian $pengembalian): bool
    {
